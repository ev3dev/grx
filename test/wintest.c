...
TESTFUNC(wintest)
{
    ...
    GrxContext *w2 =
        grx_context_new_subcontext(15 + ww, 5, ww + ww + 14, wh + 4, NULL, NULL);
    GrxContext *w3 =
        grx_context_new_subcontext(5, 15 + wh, ww + 4, wh + wh + 14, NULL, NULL);
    GrxContext *w4 = grx_context_new_subcontext(
        15 + ww, 15 + wh, ww + ww + 14, wh + wh + 14, NULL, NULL);
