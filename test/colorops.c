...
TESTFUNC(colorops)
{
    ...
    while (!run_one_main_loop_iteration()) {
        drawing(ww / 4 + (RND() % 100), wh / 4 + (RND() % 100), ww, wh,
            ((RND() / 16) & (grx_color_info_n_colors() - 1)), bg);
    }
    ...
    while (!run_one_main_loop_iteration()) {
        drawing(ww / 4 + (RND() % 100), wh / 4 + (RND() % 100), ww, wh,
            ((RND() / 16) & (grx_color_info_n_colors() - 1)) | GRX_COLOR_MODE_XOR, bg);
    }
    run_main_loop_until_key_press();
    grx_draw_framed_box(
        ww / 4 - 1, wh / 4 - 1, ww / 4 + ww + 1, wh / 4 + wh + 1, wdt, &icolors);
    ...
    while (!run_one_main_loop_iteration()) {
        drawing(ww / 4 + (RND() % 100), wh / 4 + (RND() % 100), ww, wh,
            ((RND() / 16) & (grx_color_info_n_colors() - 1)) | GRX_COLOR_MODE_OR, bg);
    }
    run_main_loop_until_key_press();
    grx_draw_framed_box(
        ww / 4 - 1, wh / 4 - 1, ww / 4 + ww + 1, wh / 4 + wh + 1, wdt, &icolors);
    ...
    while (!run_one_main_loop_iteration()) {
        drawing(ww / 4 + (RND() % 100), wh / 4 + (RND() % 100), ww, wh,
            ((RND() / 16) & (grx_color_info_n_colors() - 1)) | GRX_COLOR_MODE_AND, bg);
    }
    run_main_loop_until_key_press();
}
