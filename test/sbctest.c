...
static void drawpf( int border, GrxPixmap *pat )
{
  ...
  grx_draw_filled_box_with_pixmap( 0+border,0+border,93+border,93+border,pat );
  ...
  grx_draw_filled_circle_arc_with_pixmap( 46+border,139+border,45,-300,600,
...
static void drawp( int border, GrxLineOptions *o, GrxPixmap *p )
{
  ...
  grx_draw_circle_arc_with_pixmap( 46+border,139+border,45,-300,600,
                        GRX_ARC_STYLE_CLOSED_RADIUS,o,p );
  grx_draw_ellipse_arc_with_pixmap( 139+border,139+border,45,35,-700,400,
                         GRX_ARC_STYLE_CLOSED_RADIUS,o,p );
  grx_draw_line_with_pixmap( 188+border,139+border,278+border,139+border,o,p );
  for( i=0; i<4; i++ ) {
    ptaux[i].x = pt1[i].x + border;
    ptaux[i].y = pt1[i].y + border;
  }
