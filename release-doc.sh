...
rm -rf ${base_dir}/doc/sphinx/_html_extra/vala-api
...
mkdir -p ${base_dir}/doc/sphinx/_html_extra/vala-api
...
cp -R ${build_dir}/doc/valadoc/valadoc/* ${base_dir}/doc/sphinx/_html_extra/vala-api
