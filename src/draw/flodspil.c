 ...
 */
void grx_flood_spill(int x1, int y1, int x2, int y2, GrxColor old_c, GrxColor new_c)
{
    int y;
    int x;
 ...
 * a selected color(s) in a multi colored area.
 */
void grx_flood_spill2(int x1, int y1, int x2, int y2, GrxColor old_c1, GrxColor new_c1,
...
void grx_context_flood_spill(
    GrxContext *ctx, int x1, int y1, int x2, int y2, GrxColor old_c, GrxColor new_c)
{
    int y;
    int x;
    GrxContext ctx_save;
