...
void grx_draw_filled_rounded_box(gint x1, gint y1, gint x2, gint y2, gint r, GrxColor c)
{
    grx_draw_filled_circle_arc(
        x1 + r, y1 + r, r, 900, 1800, GRX_ARC_STYLE_CLOSED_RADIUS, c);
    grx_draw_filled_circle_arc(
        x2 - r, y1 + r, r, 0, 900, GRX_ARC_STYLE_CLOSED_RADIUS, c);
    grx_draw_filled_circle_arc(
        x1 + r, y2 - r, r, 1800, 2700, GRX_ARC_STYLE_CLOSED_RADIUS, c);
    grx_draw_filled_circle_arc(
        x2 - r, y2 - r, r, 2700, 3600, GRX_ARC_STYLE_CLOSED_RADIUS, c);
