...
/* video -> memory copies */
#ifndef INLINE_STD_FAR_COLCOPY
#define INLINE_STD_FAR_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE) \
    INLINE_STD_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE)
#endif

#ifndef INLINE_STD_FAR_OPRCOPY
#define INLINE_STD_FAR_OPRCOPY(D, S, C, DM, SM, INS, SIZE, TY) \
    INLINE_STD_FAR_COLCOPY(D, sizeof(TY), S, sizeof(TY), C, DM, SM, INS, SIZE, TY)
#endif

#ifndef INLINE_STD_FAR_ROWCOPY
#define INLINE_STD_FAR_ROWCOPY(D, S, C, DM, SM, SIZE, TYPE) \
    INLINE_STD_FAR_OPRCOPY(D, S, C, DM, SM, MOV_INS, SIZE, TYPE)
#endif

/* memory -> video copies */
#ifndef INLINE_FAR_STD_COLCOPY
#define INLINE_FAR_STD_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE) \
    INLINE_STD_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE)
#endif

#ifndef INLINE_FAR_STD_OPRCOPY
#define INLINE_FAR_STD_OPRCOPY(D, S, C, DM, SM, INS, SIZE, TY) \
    INLINE_FAR_STD_COLCOPY(D, sizeof(TY), S, sizeof(TY), C, DM, SM, INS, SIZE, TY)
#endif

#ifndef INLINE_FAR_STD_ROWCOPY
#define INLINE_FAR_STD_ROWCOPY(D, S, C, DM, SM, SIZE, TYPE) \
    INLINE_FAR_STD_OPRCOPY(D, S, C, DM, SM, MOV_INS, SIZE, TYPE)
#endif

/* video -> video copies */
#ifndef INLINE_FAR_FAR_COLCOPY
#define INLINE_FAR_FAR_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE) \
    INLINE_STD_COLCOPY(D, DSK, S, SSK, C, DM, SM, INS, SIZE, TYPE)
#endif

#ifndef INLINE_FAR_FAR_OPRCOPY
#define INLINE_FAR_FAR_OPRCOPY(D, S, C, DM, SM, INS, SIZE, TY) \
    INLINE_FAR_FAR_COLCOPY(D, sizeof(TY), S, sizeof(TY), C, DM, SM, INS, SIZE, TY)
#endif

#ifndef INLINE_FAR_FAR_ROWCOPY
#define INLINE_FAR_FAR_ROWCOPY(D, S, C, DM, SM, SIZE, TYPE) \
    INLINE_FAR_FAR_OPRCOPY(D, S, C, DM, SM, MOV_INS, SIZE, TYPE)
#endif
...
#define rowcopy_b_f_set(d, s, c) \
    INLINE_FAR_STD_ROWCOPY(d, s, c, _b_f, _b, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_set(d, s, c) \
    INLINE_FAR_STD_ROWCOPY(d, s, c, _w_f, _w, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_set(d, s, c) \
    INLINE_FAR_STD_ROWCOPY(d, s, c, _l_f, _l, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_set(d, s, c) \
    INLINE_FAR_STD_ROWCOPY(d, s, c, _h_f, _h, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_xor
#define rowcopy_b_f_xor(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _b_f_xor, _b, XOR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_xor(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _w_f_xor, _w, XOR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_xor(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _l_f_xor, _l, XOR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_xor(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _h_f_xor, _h, XOR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_or
#define rowcopy_b_f_or(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _b_f_or, _b, OR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_or(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _w_f_or, _w, OR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_or(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _l_f_or, _l, OR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_or(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _h_f_or, _h, OR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_and
#define rowcopy_b_f_and(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _b_f_and, _b, AND_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_and(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _w_f_and, _w, AND_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_and(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _l_f_and, _l, AND_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_and(d, s, c) \
    INLINE_FAR_STD_OPRCOPY(d, s, c, _h_f_and, _h, AND_INS, OP64b, GR_int64)
#endif
#endif
...
#define rowcopy_b_set_f(d, s, c) \
    INLINE_STD_FAR_ROWCOPY(d, s, c, _b, _b_f, OP8b, GR_int8)
#endif
...
#define rowcopy_w_set_f(d, s, c) \
    INLINE_STD_FAR_ROWCOPY(d, s, c, _w, _w_f, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_set_f(d, s, c) \
    INLINE_STD_FAR_ROWCOPY(d, s, c, _l, _l_f, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_set_f(d, s, c) \
    INLINE_STD_FAR_ROWCOPY(d, s, c, _h, _h_f, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_xor_f
#define rowcopy_b_xor_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _b_xor, _b_f, XOR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_xor_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _w_xor, _w_f, XOR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_xor_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _l_xor, _l_f, XOR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_xor_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _h_xor, _h_f, XOR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_or_f
#define rowcopy_b_or_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _b_or, _b_f, OR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_or_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _w_or, _w_f, OR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_or_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _l_or, _l_f, OR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_or_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _h_or, _h_f, OR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_and_f
#define rowcopy_b_and_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _b_and, _b_f, AND_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_and_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _w_and, _w_f, AND_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_and_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _l_and, _l_f, AND_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_and_f(d, s, c) \
    INLINE_STD_FAR_OPRCOPY(d, s, c, _h_and, _h_f, AND_INS, OP64b, GR_int64)
#endif
#endif
...
#define rowcopy_b_f_set_f(d, s, c) \
    INLINE_FAR_FAR_ROWCOPY(d, s, c, _b_f, _b_f, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_set_f(d, s, c) \
    INLINE_FAR_FAR_ROWCOPY(d, s, c, _w_f, _w_f, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_set_f(d, s, c) \
    INLINE_FAR_FAR_ROWCOPY(d, s, c, _l_f, _l_f, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_set_f(d, s, c) \
    INLINE_FAR_FAR_ROWCOPY(d, s, c, _h_f, _h_f, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_xor_f
#define rowcopy_b_f_xor_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _b_f_xor, _b_f, XOR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_xor_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _w_f_xor, _w_f, XOR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_xor_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _l_f_xor, _l_f, XOR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_xor_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _h_f_xor, _h_f, XOR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_or_f
#define rowcopy_b_f_or_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _b_f_or, _b_f, OR_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_or_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _w_f_or, _w_f, OR_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_or_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _l_f_or, _l_f, OR_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_or_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _h_f_or, _h_f, OR_INS, OP64b, GR_int64)
#endif
#endif

#ifndef rowcopy_b_f_and_f
#define rowcopy_b_f_and_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _b_f_and, _b_f, AND_INS, OP8b, GR_int8)
#endif
...
#define rowcopy_w_f_and_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _w_f_and, _w_f, AND_INS, OP16b, GR_int16)
#endif
#endif
...
#define rowcopy_l_f_and_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _l_f_and, _l_f, AND_INS, OP32b, GR_int32)
#endif
#endif
...
#define rowcopy_h_f_and_f(d, s, c) \
    INLINE_FAR_FAR_OPRCOPY(d, s, c, _h_f_and, _h_f, AND_INS, OP64b, GR_int64)
#endif
#endif
...
#define colcopy_b_f_set(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _b_f, _b, MOV_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_set
#define colcopy_w_f_set(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _w_f, _w, MOV_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_set)
#define colcopy_l_f_set(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _l_f, _l, MOV_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_set)
#define colcopy_h_f_set(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _h_f, _h, MOV_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_xor
#define colcopy_b_f_xor(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _b_f_xor, _b, XOR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_xor
#define colcopy_w_f_xor(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _w_f_xor, _w, XOR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_xor)
#define colcopy_l_f_xor(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _l_f_xor, _l, XOR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_xor)
#define colcopy_h_f_xor(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _h_f_xor, _h, XOR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_or
#define colcopy_b_f_or(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _b_f_or, _b, OR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_or
#define colcopy_w_f_or(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _w_f_or, _w, OR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_or)
#define colcopy_l_f_or(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _l_f_or, _l, OR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_or)
#define colcopy_h_f_or(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _h_f_or, _h, OR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_and
#define colcopy_b_f_and(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _b_f_and, _b, AND_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_and
#define colcopy_w_f_and(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _w_f_and, _w, AND_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_and)
#define colcopy_l_f_and(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _l_f_and, _l, AND_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_and)
#define colcopy_h_f_and(d, dof, s, sof, c) \
    INLINE_FAR_STD_COLCOPY(d, dof, s, sof, c, _h_f_and, _h, AND_INS, OP64b, GR_int64)
#endif
...
#define colcopy_b_set_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _b, _b_f, MOV_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_set_f
#define colcopy_w_set_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _w, _w_f, MOV_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_set_f)
#define colcopy_l_set_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _l, _l_f, MOV_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_set_f)
#define colcopy_h_set_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _h, _h_f, MOV_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_xor_f
#define colcopy_b_xor_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _b_xor, _b_f, XOR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_xor_f
#define colcopy_w_xor_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _w_xor, _w_f, XOR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_xor_f)
#define colcopy_l_xor_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _l_xor, _l_f, XOR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_xor_f)
#define colcopy_h_xor_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _h_xor, _h_f, XOR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_or_f
#define colcopy_b_or_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _b_or, _b_f, OR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_or_f
#define colcopy_w_or_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _w_or, _w_f, OR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_or_f)
#define colcopy_l_or_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _l_or, _l_f, OR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_or_f)
#define colcopy_h_or_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _h_or, _h_f, OR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_and_f
#define colcopy_b_and_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _b_and, _b_f, AND_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_and_f
#define colcopy_w_and_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _w_and, _w_f, AND_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_and_f)
#define colcopy_l_and_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _l_and, _l_f, AND_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_and_f)
#define colcopy_h_and_f(d, dof, s, sof, c) \
    INLINE_STD_FAR_COLCOPY(d, dof, s, sof, c, _h_and, _h_f, AND_INS, OP64b, GR_int64)
#endif
...
#define colcopy_b_f_set_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _b_f, _b_f, MOV_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_set_f
#define colcopy_w_f_set_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _w_f, _w_f, MOV_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_set_f)
#define colcopy_l_f_set_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _l_f, _l_f, MOV_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_set_f)
#define colcopy_h_f_set_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _h_f, _h_f, MOV_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_xor_f
#define colcopy_b_f_xor_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _b_f_xor, _b_f, XOR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_xor_f
#define colcopy_w_f_xor_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _w_f_xor, _w_f, XOR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_xor_f)
#define colcopy_l_f_xor_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _l_f_xor, _l_f, XOR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_xor_f)
#define colcopy_h_f_xor_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _h_f_xor, _h_f, XOR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_or_f
#define colcopy_b_f_or_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _b_f_or, _b_f, OR_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_or_f
#define colcopy_w_f_or_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _w_f_or, _w_f, OR_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_or_f)
#define colcopy_l_f_or_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _l_f_or, _l_f, OR_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_or_f)
#define colcopy_h_f_or_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _h_f_or, _h_f, OR_INS, OP64b, GR_int64)
#endif

#ifndef colcopy_b_f_and_f
#define colcopy_b_f_and_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _b_f_and, _b_f, AND_INS, OP8b, GR_int8)
#endif
#ifndef colcopy_w_f_and_f
#define colcopy_w_f_and_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _w_f_and, _w_f, AND_INS, OP16b, GR_int16)
#endif
#if defined(GR_int32) && !defined(colcopy_l_f_and_f)
#define colcopy_l_f_and_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _l_f_and, _l_f, AND_INS, OP32b, GR_int32)
#endif
#if defined(GR_int64) && !defined(colcopy_h_f_and_f)
#define colcopy_h_f_and_f(d, dof, s, sof, c) \
    INLINE_FAR_FAR_COLCOPY(d, dof, s, sof, c, _h_f_and, _h_f, AND_INS, OP64b, GR_int64)
#endif
...
#define fwdcopy_f_set(ap, d, s, c) INLINE_FWD_COPY(_f_set, _n, ap, d, s, c)
#endif
#ifndef fwdcopy_f_xor
#define fwdcopy_f_xor(ap, d, s, c) INLINE_FWD_COPY(_f_xor, _n, ap, d, s, c)
#endif
#ifndef fwdcopy_f_or
#define fwdcopy_f_or(ap, d, s, c) INLINE_FWD_COPY(_f_or, _n, ap, d, s, c)
#endif
#ifndef fwdcopy_f_and
#define fwdcopy_f_and(ap, d, s, c) INLINE_FWD_COPY(_f_and, _n, ap, d, s, c)
#endif
#ifndef revcopy_f_set
#define revcopy_f_set(ap, d, s, c) INLINE_REV_COPY(_f_set, _n, ap, d, s, c)
#endif
#ifndef revcopy_f_xor
#define revcopy_f_xor(ap, d, s, c) INLINE_REV_COPY(_f_xor, _n, ap, d, s, c)
#endif
#ifndef revcopy_f_or
#define revcopy_f_or(ap, d, s, c) INLINE_REV_COPY(_f_or, _n, ap, d, s, c)
#endif
#ifndef revcopy_f_and
#define revcopy_f_and(ap, d, s, c) INLINE_REV_COPY(_f_and, _n, ap, d, s, c)
#endif
...
#define fwdcopy_set_f(ap, d, s, c) INLINE_FWD_COPY(_n_set, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_xor_f
#define fwdcopy_xor_f(ap, d, s, c) INLINE_FWD_COPY(_n_xor, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_or_f
#define fwdcopy_or_f(ap, d, s, c) INLINE_FWD_COPY(_n_or, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_and_f
#define fwdcopy_and_f(ap, d, s, c) INLINE_FWD_COPY(_n_and, _f, ap, d, s, c)
#endif
#ifndef revcopy_set_f
#define revcopy_set_f(ap, d, s, c) INLINE_REV_COPY(_n_set, _f, ap, d, s, c)
#endif
#ifndef revcopy_xor_f
#define revcopy_xor_f(ap, d, s, c) INLINE_REV_COPY(_n_xor, _f, ap, d, s, c)
#endif
#ifndef revcopy_or_f
#define revcopy_or_f(ap, d, s, c) INLINE_REV_COPY(_n_or, _f, ap, d, s, c)
#endif
#ifndef revcopy_and_f
#define revcopy_and_f(ap, d, s, c) INLINE_REV_COPY(_n_and, _f, ap, d, s, c)
#endif
...
#define fwdcopy_f_set_f(ap, d, s, c) INLINE_FWD_COPY(_f_set, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_f_xor_f
#define fwdcopy_f_xor_f(ap, d, s, c) INLINE_FWD_COPY(_f_xor, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_f_or_f
#define fwdcopy_f_or_f(ap, d, s, c) INLINE_FWD_COPY(_f_or, _f, ap, d, s, c)
#endif
#ifndef fwdcopy_f_and_f
#define fwdcopy_f_and_f(ap, d, s, c) INLINE_FWD_COPY(_f_and, _f, ap, d, s, c)
#endif
#ifndef revcopy_f_set_f
#define revcopy_f_set_f(ap, d, s, c) INLINE_REV_COPY(_f_set, _f, ap, d, s, c)
#endif
#ifndef revcopy_f_xor_f
#define revcopy_f_xor_f(ap, d, s, c) INLINE_REV_COPY(_f_xor, _f, ap, d, s, c)
#endif
#ifndef revcopy_f_or_f
#define revcopy_f_or_f(ap, d, s, c) INLINE_REV_COPY(_f_or, _f, ap, d, s, c)
#endif
#ifndef revcopy_f_and_f
#define revcopy_f_and_f(ap, d, s, c) INLINE_REV_COPY(_f_and, _f, ap, d, s, c)
#endif
