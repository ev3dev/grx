...
#define clip_xdot_(c, x, when_out)                         \
    {                                                      \
        if ((x > c->x_clip_high) || (x < c->x_clip_low)) { \
            when_out;                                      \
        }                                                  \
    }
...
#define clip_ydot_(c, y, when_out)                         \
    {                                                      \
        if ((y > c->y_clip_high) || (y < c->y_clip_low)) { \
            when_out;                                      \
        }                                                  \
    }
...
#define cxclip_xdot_(c, x, when_out)                    \
    {                                                   \
        if ((unsigned int)x > (unsigned int)c->x_max) { \
            when_out;                                   \
        }                                               \
    }
...
#define cxclip_ydot_(c, y, when_out)                    \
    {                                                   \
        if ((unsigned int)y > (unsigned int)c->y_max) { \
            when_out;                                   \
        }                                               \
    }
...
#define clip_ordxrange(c, x1, x2) \
    clip_ordxrange_(c, x1, x2, return, CLIP_EMPTY_MACRO_ARG)
#define clip_ordyrange(c, y1, y2) \
    clip_ordyrange_(c, y1, y2, return, CLIP_EMPTY_MACRO_ARG)
...
#define clip_ordbox(c, x1, y1, x2, y2) \
    clip_ordbox_(c, x1, y1, x2, y2, return, CLIP_EMPTY_MACRO_ARG)
#define clip_box(c, x1, y1, x2, y2) \
    clip_box_(c, x1, y1, x2, y2, return, CLIP_EMPTY_MACRO_ARG)
...
#define cxclip_ordxrange(c, x1, x2) \
    cxclip_ordxrange_(c, x1, x2, return, CLIP_EMPTY_MACRO_ARG)
#define cxclip_ordyrange(c, y1, y2) \
    cxclip_ordyrange_(c, y1, y2, return, CLIP_EMPTY_MACRO_ARG)
...
#define cxclip_ordbox(c, x1, y1, x2, y2) \
    cxclip_ordbox_(c, x1, y1, x2, y2, return, CLIP_EMPTY_MACRO_ARG)
#define cxclip_box(c, x1, y1, x2, y2) \
    cxclip_box_(c, x1, y1, x2, y2, return, CLIP_EMPTY_MACRO_ARG)
...
#define clip_line_xmin(c, x1, y1, x2, y2) \
    clip_line_xmin_(c, x1, y1, x2, y2, CLIP_EMPTY_MACRO_ARG)
#define clip_line_xmax(c, x1, y1, x2, y2) \
    clip_line_xmax_(c, x1, y1, x2, y2, CLIP_EMPTY_MACRO_ARG)
#define clip_line_ymin(c, x1, y1, x2, y2) \
    clip_line_ymin_(c, x1, y1, x2, y2, CLIP_EMPTY_MACRO_ARG)
#define clip_line_ymax(c, x1, y1, x2, y2) \
    clip_line_ymax_(c, x1, y1, x2, y2, CLIP_EMPTY_MACRO_ARG)
#define clip_line(c, x1, y1, x2, y2) \
    clip_line_(c, x1, y1, x2, y2, return, CLIP_EMPTY_MACRO_ARG)
