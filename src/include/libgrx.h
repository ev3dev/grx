...
*/
    ...
    && (defined(__LCC__) || (defined(__GNUC__) && (__GNUC__ >= 3)) \
        || defined(__SUNPRO_C))
...
** LCC v4.0
*/
#if !defined(NO_LEFTSIDE_PTR_CAST) && (defined(__LCC__))
#define NO_LEFTSIDE_PTR_CAST
#endif

/* some CPU allow misaligned access to non byte location */
#if defined(_MSC_VER) || defined(__386__) || defined(__i386__) || defined(__i386) \
    || defined(__x86_64__)
/* x86 can write to misalgined 16bit locations */
#define MISALIGNED_16bit_OK
#endif

#if defined(__386__) || defined(__i386__) || defined(__i386) || defined(__x86_64__)
