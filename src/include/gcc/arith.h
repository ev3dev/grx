...
#define replicate_b2w(BYTE)                                                    \
    (__builtin_constant_p(BYTE) ? (long)(0x00000101UL * (GR_int8u)(BYTE)) : ({ \
...
#define replicate_w2l(WORD)                                                     \
    (__builtin_constant_p(WORD) ? (long)(0x00010001UL * (GR_int16u)(WORD)) : ({ \
        register long _repvalue;                                                \
        __asm__(                                                                \
            "movw    %w1,%w0  "                                                 \
            "\n\t"                                                              \
...
#define replicate_b2l(BYTE)                                                    \
    (__builtin_constant_p(BYTE) ? (long)(0x01010101UL * (GR_int8u)(BYTE)) : ({ \
        register long _repvalue;                                               \
        __asm__(                                                               \
            "movb    %b1,%b0  "                                                \
            "\n\t"                                                             \
