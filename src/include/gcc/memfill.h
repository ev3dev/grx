    ...
    ({                                                                                \
        if (__builtin_constant_p(SKIP) && ((SKIP) == 1))                              \
            __asm__ volatile(                                                         \
                ...
                "    jne     0b"                                                      \
                : "=r"((void *)(P)), "=r"((int)(C))                                   \
                : "0"((void *)(P)), "1"((int)(C)), "qn"((TYPE)(V))                    \
                : "memory");                                                          \
        else if (__builtin_constant_p(SKIP) && ((SKIP) == 2))                         \
            __asm__ volatile(                                                         \
                ""                                                                    \
                "    incl    %1                           \n"                         \
                "    shrl    $1,%1                        \n"                         \
                ...
                : "0"((void *)(P)), "1"((int)(C)), "qn"((TYPE)(V))                    \
                : "memory");                                                          \
        else if (__builtin_constant_p(SKIP) && ((SKIP) == 4))                         \
            __asm__ volatile(                                                         \
                ""                                                                    \
                "    incl    %1                           \n"                         \
                "    shrl    $1,%1                        \n"                         \
            ...
            __asm__ volatile(                                                         \
                ...
                "    jne     0b"                                                      \
                : "=r"((void *)(P)), "=r"((int)(C))                                   \
                : "0"((void *)(P)), "1"((int)(C)), "ng"((int)(SKIP)), "qn"((TYPE)(V)) \
                : "memory");                                                          \
    })
...
#define __INLINE_386_REPFILL24__(p, c, b, INS, SEG)                               \
    do {                                                                          \
        int _dummy_;                                                              \
        __asm__ volatile(                                                         \
            "\n"                                                                  \
