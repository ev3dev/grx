 ...
 * color stuff
 */
G_GNUC_INTERNAL extern int
    _GR_firstFreeColor; /* can't access all colors on all systems */
G_GNUC_INTERNAL extern int
    _GR_lastFreeColor; /* eg. X11 and other windowing systems    */
G_GNUC_INTERNAL int _GrResetColors(
    void); /* like grx_color_info_reset_colors but return true on success */
