...
const struct _GR_colorInfo *const GrColorInfo = &_GrColorInfo;
struct _GR_colorInfo
    _GrColorInfo = { .ncolors = 16, /* ncolors: initted for 16 color VGA modes */
        .nfree = 0,                 /* nfree */
        .black = 0,                 /* black */
        .white = 15,                /* white */
        .palette_type = GRX_COLOR_PALETTE_TYPE_COLOR_TABLE,
