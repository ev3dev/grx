...
struct _GR_driverInfo _GrDriverInfo = {
    ...
    .fdriver = {
        ...
        .max_mem_size   = 0,
        .init        = NULL,
        .readpixel   = (GrxColor (*)(const GrxFrame*,int,int))dummyframefn,
        ...
        .bitblt      = (void (*)(const GrxFrame*,int,int,const GrxFrame*,int,int,int,int,GrxColor)) dummyframefn,
        .bltv2r      = (void (*)(const GrxFrame*,int,int,const GrxFrame*,int,int,int,int,GrxColor)) dummyframefn,
        .bltr2v      = (void (*)(const GrxFrame*,int,int,const GrxFrame*,int,int,int,int,GrxColor)) dummyframefn
    },
    /* screen frame driver */
    .sdriver = {
        .mode           = GRX_FRAME_MODE_UNDEFINED,
