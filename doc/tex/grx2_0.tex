...
uses svgalib. On X11 it must work on any X11R5 (or later). From the 2.4 version,
GRX comes with a Win32 driver, but you must considere it in alpha stage. 
...
@end example
Note. With the Win32 version you must use GRXMain instead main by now. 
...
@node Writing/reading PNM graphics files, Miscellaneous functions,Mouse event handling , A User Manual For GRX2
...
@node Miscellaneous functions, BGI interface, Writing/reading PNM graphics files, A User Manual For GRX2
