...
the last GRX release come with drivers to load the GRX own font format for all
...
@node Miscellaneous functions, References, Writing/reading JPEG graphics files, A User Manual For GRX2
...
@c -----------------------------------------------------------------------------
@node References, , Miscellaneous functions, A User Manual For GRX2
