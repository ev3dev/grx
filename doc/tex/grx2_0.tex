...
driver was new in 2.4.2 and it is in alpha stage too.
...
@node Writing/reading PNG graphics files, Miscellaneous functions, Writing/reading PNM graphics files, A User Manual For GRX2
...
grc must be a pointer to the context to be written, is it
...
@node Miscellaneous functions, BGI interface, Writing/reading PNG graphics files, A User Manual For GRX2
